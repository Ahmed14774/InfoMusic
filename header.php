  ...
  <header>
    ...
    <div class="container-fluid">
      ...
      <nav class="navbar navbar-expand-lg  navbar-dark bg-dark nav-fill w-100">
        <a class="navbar-brand headphone" href="index.php">
          <span>
            ...
            if (isset($_SESSION['userId'])) {
              ...
              echo '<ul class="navbar-nav">
                ...
                <div class="signup-login">
                  <a href="signuppage.php"><button type="button" class="btn  btn-outline-light">Sign Up</button></a>
                  <a href="loginpage.php"><button type="button" class="btn  btn-outline-light">Login</button></a>
                </div>';
            }
           ?>
        </div>
